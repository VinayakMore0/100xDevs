...
import { addBookmark, deleteBookmark, favoriteBookmark, getAllBookmarks, searchBookmark } from './routes/bookmarks.js'; // importing callback functions for routes
const app = express();
const PORT = 3001;
...
app.get('/bookmarks/favorite', favoriteBookmark);
